...
const Stat = () => {
  ...
  <div className="text-center space-y-3">
    <h3 className="font-extrabold text-3xl lg:text-6xl text-center space-y-3">50K+</h3>
    <p className='opacity-60'>Active Users</p>
  </div>
  <div className="text-center space-y-3">
    <h3 className="font-bold text-3xl lg:text-6xl">200+</h3>
    <p className='opacity-60'>Premium Tools</p>
  </div>
  <div className="text-center space-y-3">
    <h3 className="font-bold text-3xl lg:text-6xl text-center space-y-3">4.9</h3>
